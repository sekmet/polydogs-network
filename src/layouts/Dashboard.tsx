...
const AuthApp = (props: IAuthProps) => {
  ...
  return (
    <div
      id="loading-screen"
      className="block fixed top-0 left-0 w-full h-full bg-white opacity-75 z-300"
    >
      <span className="block relative top-1/2 my-0 mx-auto w-0 h-0 text-blue-500 opacity-75">
        <div className="mx-auto text-center">
          <svg
            role="status"
            className="inline my-0 mx-auto w-24 h-24 text-gray-200 dark:text-gray-600 animate-spin fill-pink-600"
            viewBox="0 0 100 101"
            fill="none"
