const getParamOrExit = (name: string) => {
  ...
  if (!param) {
    ...
    !process.browser && process.exit(1);
  }
  return param;
};
...
export const PK = process.env.PK; //getParamOrExit('PK');

export const MUMBAI_RPC_URL = process.env.MUMBAI_RPC_URL; //getParamOrExit('MUMBAI_RPC_URL');

export const LENS_API = process.env.LENS_API; //getParamOrExit('LENS_API');

export const LENS_HUB_CONTRACT = process.env.LENS_HUB_CONTRACT; //getParamOrExit('LENS_HUB_CONTRACT');

export const PROFILE_ID = process.env.PROFILE_ID; //getParam('PROFILE_ID');
